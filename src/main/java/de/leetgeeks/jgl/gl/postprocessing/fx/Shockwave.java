 ...
 * Time: 14:32
 */
public class Shockwave extends BasePostProcess {
    @Override
    ...
    protected void initResources() {
        try {
            ...
            String fragmentShaderSource = ResourceUtil.getResourceFileAsString("/shader/shockwaveFrag.glsl", this.getClass());
